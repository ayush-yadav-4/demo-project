...
import { 
  Database, Server, Cloud, Code, Settings, Cpu, Layers, 
  Lock, CheckCircle2, ArrowRight, Workflow, RefreshCw 
} from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Streamline your entire business operation, from finance to supply chain, with custom-built ERP systems designed for your workflows."
    },
    {
      icon: Workflow,
      title: "Custom CRM Solutions",
      description: "Build tailored customer relationship management tools that fit your sales process perfectly and drive better engagement."
    },
    {
      icon: Cloud,
      title: "SaaS Product Development",
      description: "Launch scalable, multi-tenant cloud applications with robust architecture designed for high availability and growth."
    },
    {
      icon: RefreshCw,
      title: "Legacy System Modernization",
      description: "Transform outdated software into modern, efficient applications without losing critical data or business logic."
    },
    {
      icon: Server,
      title: "Cloud Migration & DevOps",
      description: "Securely transition your infrastructure to AWS or Azure with automated CI/CD pipelines and containerization."
    },
    {
      icon: Code,
      title: "API Development & Integration",
      description: "Connect disparate systems and enable seamless data flow with secure, high-performance REST and GraphQL APIs."
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "We conduct a deep dive into your business logic, user workflows, and technical constraints to define a precise project scope."
    },
    {
      step: "02",
      title: "System Architecture",
      description: "Our architects design a scalable database schema, select the optimal tech stack, and plan for security and performance."
    },
    {
      step: "03",
      title: "Iterative Development",
      description: "We build your software in agile sprints, providing regular demos and gathering feedback to ensure alignment with your vision."
    },
    {
      step: "04",
      title: "QA & Deployment",
      description: "Rigorous automated testing and seamless CI/CD pipelines ensure a bug-free launch and easy future updates."
    }
  ];

  const techStack = ["Java", ".NET Core", "Python", "Docker", "Kubernetes", "PostgreSQL", "Redis", "Azure"];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 mb-8">
              ...
              <span className="text-sm font-semibold text-blue-700">Enterprise-Grade Solutions</span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="text-xl text-slate-600 max-w-2xl mb-10 leading-relaxed">
              From modernizing legacy systems to building scalable SaaS platforms, we deliver robust software tailored to your enterprise needs.
            </motion.p>
      ...
      <section className="py-24 bg-blue-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">End-to-end software engineering services designed for scalability and performance.</p>
          </div>
            ...
            <div className="mb-12 lg:mb-0">
              <div className="sticky top-32">
                ...
                <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                  We follow industry-best practices to ensure your software is secure, scalable, and built to last.
                </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10">
                Let's build a solution that grows with you. Transform your business with custom software.
              </p>
